...
```{r, cache=FALSE, fig.show="hold", out.width="50%", fig.cap="FIGURE 1: The fitted normal mixture model with unequal variances (left) and equal variance(right)"}
...
```{r, fig.show="hold", out.width="50%", cache=FALSE, eval=TRUE, fig.cap="FIGURE 2: The fitted Weibull mixture model (left) and Normal mixture model (right) to the same data"}
...
```{r, fig.show="hold", out.width="50%", cache=FALSE, eval=TRUE, fig.cap="FIGURE 3: The value of BIC for Weibull mixture models (left) and Normal mixture models (right) with different values of $g$."}
...
```{r, fig.show="hold", out.width="50%", cache=FALSE, eval=TRUE, fig.cap="FIGURE 4: The fitted Weibull mixture model with $g = 2$ (left) and the Normal mixture model with $g = 4$ and equal variance (right)"}
plot(mod2_weibull)
...
```{r, fig.show="hold", out.width="50%", cache=FALSE, eval=TRUE, fig.cap="FIGURE 6: (left) The Normal mixture model fitted with binned data; (right) The Weibull mixture model fitted with binned data."}
...
```{r, fig.show="hold", out.width="50%", cache=FALSE, eval=TRUE, fig.cap="FIGURE 7: Normal mixture models fitted to the raw data (left) and binned data (right)"}
